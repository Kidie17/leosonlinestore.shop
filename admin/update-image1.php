...
<head>
    <meta charset="UTF-8">
    <title>Update Product Image 1</title>
...
<div class="container-fluid">
    ...
    <h2 class="fw-bold text-uppercase" style="letter-spacing: 1px;">UPDATE PRODUCT IMAGE 1</h2>
</div>
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="productimages/<?= $pid ?>/<?= htmlentities($row['productImage1']) ?>" width="250" class="img-thumbnail">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">New Product Image</label>
                            <input type="file" class="form-control" name="productimage1" required>
                        </div>
