...
if(strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        move_uploaded_file($_FILES["productimage3"]["tmp_name"], "productimages/$pid/" . $productimage3);
...
<head>
    <meta charset="UTF-8">
    <title>Update Product Image 3</title>
...
<div class="container-fluid">
    ...
    <h2 class="fw-bold text-uppercase" style="letter-spacing: 1px;">UPDATE PRODUCT IMAGE 3</h2>
</div>
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <img src="productimages/<?= $pid ?>/<?= htmlentities($row['productImage3']) ?>" width="250" class="img-thumbnail">
                        </div>
