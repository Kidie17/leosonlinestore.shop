...
<div class="container-fluid">
    ...
    <h2 class="fw-bold text-uppercase" style="letter-spacing: 1px;">DELIVERED ORDERS</h2>
</div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="updateorder.php?oid=<?php echo htmlentities($row['id']); ?>" class="btn btn-sm btn-primary" title="Update Order" target="_blank">
